...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //recohecedor de gestos
        let reconhecedorGesto = UILongPressGestureRecognizer(target: self, action: #selector(marcar(gesture:)))
    ...
    func exibirAnotacao(viagem: Dictionary<String, String>){
        //exibie anotação com os dados de endereço
